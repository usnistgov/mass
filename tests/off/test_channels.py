...
class TestOFFTutorial:  # noqa PLR0904
    ...
    def setup_class(cls):
        ...
        ds.calibrateFollowingPlan("filtValueDC", approximate=False)
        ...
        with tempfile.TemporaryDirectory() as tdir:
            ...
            with h5py.File(outfile, "w") as h5:
                data.qualityCheckLinefit("Ne H-Like 3p", positionToleranceAbsolute=2,
    ...
    def test_fixed_behaviors(self):
        assert self.ds.stateLabels == ["Ne", "W 1", "Os", "Ar", "Re", "W 2", "CO2", "Ir"]
    ...
    def test_save_load_recipes(self, tmp_path):
        filename = self.filename
        data = self.data
    ...
    def test_save_load_recipe_book(self, tmp_path):
        ds = self.ds
        rb = ds.recipes
    ...
    def test_hists_to_hdf5(self, tmp_path):
        data = self.data
