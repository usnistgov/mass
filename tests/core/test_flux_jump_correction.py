...
class Test_unwrap_n:
    ...
    def test_no_unwrap(self):
        unwrapped = unwrap_n(self.data, self.noise_size / 10, self.mask, n=0)
    ...
    def test_period_limits(self):
        ...
        unwrapped = unwrap_n(self.data, period, self.mask, n=1)
    ...
    def test_same_as_numpy(self):
        unwrapped = unwrap_n(self.data, self.noise_size / 10, self.mask, n=1)
    ...
    def test_lengths(self):
        ...
        period = max_diff * 1.99
        unwrapped = unwrap_n(data, period, self.mask, n=5)
