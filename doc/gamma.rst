...
.. testcode::
  ...
  projectors_mass_hdf5 = os.path.join(d, "20181018_144520_mass_projectors.hdf5")
  projectors_mass_noise_hdf5 = os.path.join(d, "20181018_144325_noise_mass_projectors.hdf5")
...
.. testcode::
  ...
  with h5py.File(model_hdf5,"w") as h5:
      mass.make_projectors(pulse_files=pulse_files,
          ...
          mass_hdf5_path=projectors_model_mass_hdf5,
          mass_hdf5_noise_path=projectors_mass_noise_hdf5,
          invert_data=False,
