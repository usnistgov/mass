...
def find_local_maxima(pulse_heights, gaussian_fwhm):
    ...
    Args:
        pulse_heights (numpy.array(dtype=float)): a list of pulse heights (eg p_filt_value)
...
def find_opt_assignment(peak_positions, line_names, nextra=2, nincrement=3, nextramax=8, maxacc=0.015):
    ...
    Args:
        peak_positions (numpy.array(dtype=float)): a list of peak locations in arb units,
