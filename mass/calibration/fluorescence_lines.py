...
def addline(element, linetype, material, reference_short, reference_plot_instrument_gaussian_fwhm,
    ...
    :type element: str
    :param linetype: line Siegbahn name, or other name
    :type linetype: str
    :param material: material type (e.g., "metal")
    :type material: str
    :param reference_short: key into the reference database `mass.calibration.fluorescence_lines.lineshape_references`
    :type reference_short: str
    :param reference_plot_instrument_gaussian_fwhm: The FWHM of the instrument used in the reference plot
    :type reference_plot_instrument_gaussian_fwhm: float
    :param nominal_peak_energy: nominal energy of the most intense peak
    :type nominal_peak_energy: float
    :param energies: the Lorentzian center energies
    :type energies: ndarray
    :param lorentzian_fwhm: the Lorentzian widths (FWHM)
    :type lorentzian_fwhm: ndarray
    :param reference_amplitude: the line intensities (meaning specified by `reference_amplitude_type`)
    :type reference_amplitude: ndarray
    :param reference_amplitude_type: one of LORENTZIAN_PEAK_HEIGHT, LORENTZIAN_INTEGRAL_INTENSITY, or VOIGT_PEAK_HEIGHT
    :type reference_amplitude_type: int
    :param ka12_energy_diff: _description_, defaults to None
    :type ka12_energy_diff: float, optional
    :param fitter_type: _description_, defaults to None
    :type fitter_type: _type_, optional
    :param position_uncertainty: _description_, defaults to np.NaN
    :type position_uncertainty: _type_, optional
    :param intrinsic_sigma: _description_, defaults to 0
    :type intrinsic_sigma: int, optional
    :param reference_measurement_type: _description_, defaults to None
    :type reference_measurement_type: _type_, optional
    :param is_default_material: _description_, defaults to True
    :type is_default_material: bool, optional
    :param allow_replacement: _description_, defaults to False
    :type allow_replacement: bool, optional
    :raises ValueError: _description_
    :return: the line model
    :rtype: mass.calibration.SpectralLine
    """
