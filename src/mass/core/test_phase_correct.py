...
# if os.path.isfile(new_src_name):
#     os.remove(new_src_name)
# shutil.copyfile(src_name, new_src_name)
# for i in range(12):
#     mass.ljh_modify.ljh_append_traces(src_name, new_src_name, np.arange(300))
# mass.ljh_modify.ljh_append_traces(src_name, new_src_name, np.arange(100-17))
...
#     fitter.fit(counts, bin_edges,params=params, label="full", axis=plt.gca(), hold=hold)
