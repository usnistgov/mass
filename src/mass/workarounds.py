"""
A set of workarounds for bugs and things.

1. matplotlib bug when plotting log-scale filled histograms causes y-axis to be stupid.
...
# I submitted this to the maintainers (see https://sourceforge.net/tracker/?func=detail&atid=560720&aid=3191578&group_id=80706)
    ...
    **kwargs):
        ...
        **Example:**
        ...
        if histtype.startswith('bar'):
            ...
            # These are the only 2 changed lines (Joe Fowler, NIST) #######################
            ndata = np.array(n)
